...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="/goods/list">제품현황</a></li>
        </c:if>
		<c:if test="${login.grno < 4 }">
        <li><a href="/order/list">주문현황</a></li>
        </c:if>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
			...
			<li>
				<a href="/order/mylist/${login.id}"><i class="fas fa-user-circle"></i></a>
			</li>
			<li>
				<a href="/basket/mylist/${login.id }"><i class="fas fa-shopping-cart"></i></a>
			</li>
				<!-- 관리 -->
