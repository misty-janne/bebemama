				...
				<tbody>
					<c:forEach items="${list }" var="dto">
						<tr>
							...
							<select id="grno" name="grno" class="form-control">
							<option value="${dto.grno }" selected>${dto.authority }</option>
							<option value="${dto.grno }">consumer</option>
							<option value="${dto.grno }">marketer</option>
							<option value="${dto.grno }">ceo</option>
							</select>
							</td>
						<c:if test="${login.grno == 2 || login.grno == 1}">
							<td>						
